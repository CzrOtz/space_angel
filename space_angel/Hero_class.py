...
class Hero: 
    def __init__(self, hero_image, size_of_hero, position_x, position_y, rect_width, rect_heigh):
        ...
        self.y_gravity = 2 #it was 2
        self.jump_height = 35 #it was 27
    ...
    def debug(self):
        print(" ||||",self.position_x, '  <= that position_x  ', end=' ')
        print("||||",self. position_y, ' <= thas is position_y  ', end = '')
        print("||||",self.jump_height, ' <= this is jump height  ', end='')
        print("||||",self.y_velocity, ' <= this is y_velocity  ', end=''),
        print("||||",self.y_gravity, ' <= this is y_gravity  ',)
